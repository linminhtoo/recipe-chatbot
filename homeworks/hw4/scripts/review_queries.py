...
class QueryReviewer:
    ...
    def review_queries_interactive(self, queries: List[Dict[str, Any]], max_review: int = 20) -> List[Dict[str, Any]]:
    ...
    def batch_filter_queries(self, queries: List[Dict[str, Any]], criteria: Dict[str, Any]) -> List[Dict[str, Any]]:
...
def main():
    ...
    if mode in ["2", "3"]:
        ...
        filter_criteria = {"min_query_words": 5, "max_query_words": 15}
