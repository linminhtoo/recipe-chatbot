...
2. The configured vLLM-backed model is asked to pick a plausible `last_success_state` that precedes it.
3. The same model then writes a short conversation (≤ 10 messages) that succeeds
