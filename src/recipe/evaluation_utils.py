...
def compare_retrieval_systems(
    results_baseline: List[Dict[str, Any]], results_enhanced: List[Dict[str, Any]]
) -> Dict[str, Any]:
    ...
    return {"baseline_metrics": metrics_baseline, "enhanced_metrics": metrics_enhanced, "improvements": improvements}
...
def print_comparison_results(comparison: Dict[str, Any]):
    ...
    if recall5_improvement > 5 and mrr_improvement > 5:
        print("   • Significant improvement in both recall and ranking quality")
    elif recall5_improvement > 5:
        print("   • Good improvement in recall, moderate ranking improvement")
    elif mrr_improvement > 5:
        print("   • Good improvement in ranking quality, moderate recall improvement")
